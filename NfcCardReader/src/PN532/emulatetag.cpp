...
void EmulateTag::setNdefFile(const uint8_t *ndef, const int16_t ndefLength)
{
  ...
  {
    DMSG("EmuTag: ndef file too large (> NDEF_MAX_LENGHT -2) - aborting");
    return;
  }
...
bool EmulateTag::emulate(const uint16_t tgInitAsTargetTimeout)
{
  ...
  {
    DMSG("EmuTag: tgInitAsTarget failed or timed out!");
    return false;
  }
  ...
  while (runLoop)
  {
    ...
    case ISO7816_SELECT_FILE:
      ...
      case C_APDU_P1_SELECT_BY_NAME:
        ...
        {
          DMSG("EmuTag: function not supported\n");
    ...
    case ISO7816_UPDATE_BINARY:
      ...
      break;
    default:
      DMSG("EmuTag: Command not supported!");
